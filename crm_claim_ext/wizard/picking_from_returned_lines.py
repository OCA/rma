...
class picking_in_from_returned_lines(osv.osv_memory):
    ...
    _columns = {
        'claim_line_location': fields.many2one('stock.location',
                                               'Dest. Location',
    ...
    def _get_dest_loc(self, cr, uid, context):
        return self.pool.get('stock.warehouse').\
            read(cr, uid, [1], ['lot_input_id'])[0]['lot_input_id'][0]
