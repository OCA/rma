...
class get_empty_serial(orm.TransientModel):
    ...
    _columns = {
        # 'prodlot_ids':
        # fields.many2many('temp.return.line',
        #                  'return_rel',
        #                  'wizard_id',
        #                  'temp_return_line_id', 'Return lines'),
        # 'prodlot_ids': fields.many2one('stock.production.lot',
        #                                'Serial / Lot Number 1',
        #                                required=True),
    ...
    def temp_display_results(self, cr, uid, context):
        ...
        temp_display = ""
        # print "partner_id : ",
        self.pool.get('crm.claim').read(cr,
                                        uid,
                                        context['active_id'],
                                        ['partner_id'])['partner_id']
# print "partner_id : ",self.pool.get('crm.claim').read(cr, uid,
# context['active_id'], ['partner_id'])['partner_id']
        # print context
