...
class returned_lines_from_invoice_invoice(osv.osv_memory):
    ...
    def _get_default_partner_id(self, cr, uid, context):
        return self.pool.get('crm.claim').\
            read(cr, uid, context['active_id'], ['partner_id'])['partner_id']
    ...
    def action_return_all(self, cr, uid, ids, context):
        ...
        for invoice_line in \
                invoice_line_pool.browse(cr, uid, invoice_lines_ids):
...
class temp_claim_line(osv.osv_memory):
    ...
    _columns = {
        ...
        'product_returned_quantity': fields.float('Returned quantity',
                                                  digits=(12, 2),
                                                  help="Quantity"
                                                  " of product returned"),
